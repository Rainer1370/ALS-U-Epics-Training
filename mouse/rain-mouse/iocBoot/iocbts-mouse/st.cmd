...
#--
epicsEnvSet("ENGINEER",  "rain")
epicsEnvSet("LOCATION",  "SoftIOC")
epicsEnvSet("WIKI", "")
#-- 
epicsEnvSet("IOCNAME", "bts-mouse")
epicsEnvSet("IOC", "iocbts-mouse")
#--
epicsEnvSet("PRE", "AAAA:")
epicsEnvSet("REC", "BBBB:")

dbLoadDatabase "dbd/mouse.dbd"
mouse_registerRecordDeviceDriver pdbbase
...
#-- access control list
#--asSetFilename("$(DB_TOP)/access_securitybts-mouse.acf")
...
#--iocshLoad("$(IOCSH_LOCAL_TOP)/mouse.iocsh", "P=$(PRE),R=$(REC),DATABASE_TOP=$(DB_TOP),PORT=$(PORT1),IPADDR=$(PORT1_IP),IPPORT=$(PORT1_PORT)")
